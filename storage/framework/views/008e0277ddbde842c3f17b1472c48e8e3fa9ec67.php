...
<?php echo e($prm->opexdes); ?>

</br>
<?php echo e($prm->price); ?>
...
var filename =  $('#my-file').val();
     ...
     var databaseref9900 = firebase.database().ref().child('operations/<?php echo e($prm->mainid); ?>/');
     var databaseref99 = databaseref9900.child('ex/');
         ...
         var stoargeRef99 = firebase.storage().ref('operations/<?php echo e($prm->mainid); ?>/') ; // folder name
                 ...
                 uploadTask.snapshot.ref.getDownloadURL().then(function (downloadUrl) {
                     ...
                     databaseref99.set(Blogdata , function (err) {
                         ...
                         else
                         {
                             ...
                             alert(" تم التحميل بنجاح");
                          window.location.href = '/addbeaf/<?php echo e($prm->mainid); ?>';
                         }
...
</html><?php /**PATH /Users/a1/Desktop/this copy 4/resources/views//addopfiles.blade.php ENDPATH**/ ?>