...
<center>
<button  id="addfile" class="btn btn-primary"style="margin-top:10px ;"> اضافة صورة الخدمة الخارجية : </button>
</center>
...
<center>
<button  id="addfile2" class="btn btn-primary"style="margin-top:10px ;"> اضافة صورة الخدمة الداخلية : </button>
</center>
...
var filename =  $('#my-file').val();
     ...
     var databaseref9900 = firebase.database().ref().child('services/<?php echo e($prm->mainid); ?>/');
     var databaseref99 = databaseref9900.child('ex/');
         ...
         var stoargeRef99 = firebase.storage().ref('services/<?php echo e($prm->mainid); ?>/') ; // folder name
...
</html><?php /**PATH /Users/a1/Desktop/this copy 4/resources/views//addserfiles.blade.php ENDPATH**/ ?>