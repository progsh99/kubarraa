...
<div class="packages-overview">
    <dl class="pricing pricing--personal">
        ...
        <dd class="pricing__data pricing__data--package"><?php echo e($pr->title); ?></dd>
        <dt class="pricing__title">Price per month</dt>
        <dd class="pricing__data pricing__data--price"><span class="currency currency--dollar"><?php echo e($pr->price); ?></span> <span class="hidden-but-relevant">dollars</span></dd>
        <dt class="pricing__title">Package Overview</dt>
        <dd class="pricing__data pricing__data--overview"><?php echo e($pr->offer); ?></dd>
        <dt class="pricing__title">Package Offers</dt>
        <dt class="pricing__title">Package Action</dt>
        <dd class="pricing__data pricing__data--action"><a href="/deleteoffer/<?php echo e($pr->id); ?>" class="button"> حذف هذا العرض</a></dd>
    </dl>
...
<?php /**PATH /Users/a1/Desktop/this copy 4/resources/views/showoffers.blade.php ENDPATH**/ ?>