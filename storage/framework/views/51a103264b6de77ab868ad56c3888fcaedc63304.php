    ...
    <article class="dashboard-content">
        ...
        <section class="section">
            ...
            <ul class="monitor-list">
                ...
                <li class="monitor-list__item active">
                <div class="monitor-gauge">
                        <p style="color:white;"><?php echo e($pr2); ?></p>
                    </div>
                    <div class="monitor-data">
                        <div >عدد المكاتب  </div>
                ...
                <li class="monitor-list__item active">
                <div class="monitor-gauge">
                        <p style="color:white;"><?php echo e($pr3); ?></p>
                    </div>
                    <div class="monitor-data">
                        <div >عدد العروض  </div>
                ...
                <li class="monitor-list__item active">
                <div class="monitor-gauge">
                        <p style="color:white;" ><?php echo e($pr); ?></p>
                    </div>
                    <div class="monitor-data">
                ...
                <li class="monitor-list__item active">
                <div class="monitor-gauge">
                        <p style="color:white;" ><?php echo e($pr4); ?></p>
                    </div>
                    <div class="monitor-data">
                        <div >عدد الخدمات  </div>
...
<?php /**PATH /Users/a1/Desktop/this copy 4/resources/views/dashboard.blade.php ENDPATH**/ ?>