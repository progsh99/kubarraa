...
<body>
<h2 style="margin-top :5%;"> اضافة  نتائج العملية : </h2>
<center id="maince">
</br>
</br>
</br>
...
<center>
<button  id="addfile" class="btn btn-primary"style="margin-top:10px ;"> اضافة الصورة : </button>
</center>
...
<center>
<button  id="addfile2" class="btn btn-primary"style="margin-top:10px ;">   تمت الاضافة </button>
</center>
...
var filename =  $('#my-file').val();
     ...
     var databaseref9900 = firebase.database().ref().child('operations/<?php echo e($prm); ?>/beaf/');
         ...
         var stoargeRef99 = firebase.storage().ref('operations/<?php echo e($prm); ?>/beaf/') ; // folder name
    ...
    uploader.value = percentage;
             ...
             function complete () {
                 ...
                 uploadTask.snapshot.ref.getDownloadURL().then(function (downloadUrl) {
                     ...
                     databaseref9900.push(Blogdata , function (err) {
                         if(err) {
...
</html><?php /**PATH /Users/a1/Desktop/this copy 4/resources/views/addbeaf.blade.php ENDPATH**/ ?>