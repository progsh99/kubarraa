...
<center>
<button  id="addfile" class="btn btn-primary"style="margin-top:10px ;"> اضافة صورة الوجهة   </button>
</center>
...
var filename =  $('#my-file').val();
     ...
     var databaseref99 = firebase.database().ref().child('country/<?php echo e($prm->id); ?>/');
   //  var databaseref99 = databaseref9900.child('ex/');
         ...
         var stoargeRef99 = firebase.storage().ref('country/<?php echo e($prm->id); ?>/') ; // folder name
...
</html><?php /**PATH /Users/a1/Desktop/this copy 4/resources/views//addconfiles.blade.php ENDPATH**/ ?>