            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-signin"  method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="row mb-3">
                            <label for="email" id="email" class="col-md-4 col-form-label text-md-end"><?php echo e(__('E-Mail Address')); ?></label>
...
<body>
  </html><?php /**PATH /Users/a1/Desktop/this copy 4/resources/views/mylogin.blade.php ENDPATH**/ ?>